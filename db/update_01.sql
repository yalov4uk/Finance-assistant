...
ALTER TABLE account DROP FOREIGN KEY FK7m8ru44m93ukyb61dfxw0apf6;
ALTER TABLE account
  ADD CONSTRAINT FK7m8ru44m93ukyb61dfxw0apf6
FOREIGN KEY (user_id) REFERENCES user (id) ON DELETE CASCADE;

ALTER TABLE category DROP FOREIGN KEY FKpfk8djhv5natgshmxiav6xkpu;
ALTER TABLE category
...
ALTER TABLE transaction DROP FOREIGN KEY FKgik7ruym8r1n4xngrclc6kiih;
ALTER TABLE transaction
  ADD CONSTRAINT FKgik7ruym8r1n4xngrclc6kiih
FOREIGN KEY (category_id) REFERENCES category (id) ON DELETE CASCADE;
ALTER TABLE transaction DROP FOREIGN KEY FKsg7jp0aj6qipr50856wf6vbw1;
ALTER TABLE transaction
  ADD CONSTRAINT FKsg7jp0aj6qipr50856wf6vbw1
FOREIGN KEY (user_id) REFERENCES user (id) ON DELETE CASCADE;

ALTER TABLE transfer DROP FOREIGN KEY FKfbrtpigqywdcc6e64ichki73j;
ALTER TABLE transfer
  ADD CONSTRAINT FKfbrtpigqywdcc6e64ichki73j
FOREIGN KEY (from_account_id) REFERENCES account (id) ON DELETE CASCADE;
ALTER TABLE transfer DROP FOREIGN KEY FKrppn0djf9uip7gj308swxq54j;
ALTER TABLE transfer
  ADD CONSTRAINT FKrppn0djf9uip7gj308swxq54j
FOREIGN KEY (to_account_id) REFERENCES account (id) ON DELETE CASCADE;
ALTER TABLE transfer DROP FOREIGN KEY FKddbjk8kle2s7siw04lua30sjl;
ALTER TABLE transfer
