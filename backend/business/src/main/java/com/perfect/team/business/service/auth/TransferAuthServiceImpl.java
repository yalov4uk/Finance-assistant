...
@Service
public class TransferAuthServiceImpl extends AuthCrudServiceBase<Transfer> implements
    TransferAuthService {
  ...
  public Long create(Transfer bean) {
    if (bean.getFromAccount() == null) {
      throw new ValidationException("From account is null");
    }
    if (bean.getToAccount() == null) {
      throw new ValidationException("To account is null");
    }
